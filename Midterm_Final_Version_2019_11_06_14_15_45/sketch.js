...
function Scene2() {
  ...
  rect(300, 60, 600, 70);
  //Boundaries
  if(me1.meX<41&&me1.meY<95&&me1.meY>40){
    me1.meX=0;
    me1.meY=0;}
  if(me1.meX>120&&me1.meX<482&&me1.meY>95&&me1.meY<115){
    me1.meX=0;
    me1.meY=0;
  }
  //STAIRS LEFT
  ...
  rect(552, 180, 20, 5);
 //Boundaries
  if(me1.meX>120&&me1.meX<482&&me1.meY>185&&me1.meY<205){
    me1.meX=0;
    me1.meY=0;
  }
  //STAIRS RIGHT
  ...
  rect(200, 172, 68, 12);
  //Dialogue
  if(mouseX>175&&mouseX<225&&mouseY>155&&mouseY<170){
    fill(255,255,255,200);
    text("Not sure what kind of liquid is on me...",120,155);}
  //PAPERBAG
  fill(230, 202, 179);
  rect(150, 177, 12, 15);
  rect(154, 167, 2, 5);
  ...
  rect(150, 165, 8, 2);
   //Dialogue
  if(mouseX>146&&mouseX<156&&mouseY>170&mouseY<184){
  fill(255,255,255,200);
  text("Just a paper bag.",110,160);}
  //Trash
  fill(194, 194, 214, random(100, 230));
  ...
  rect(98, 274, 44, 3); 
  //Boundaries
  if(me1.meX>120&&me1.meX<482&&me1.meY>275&&me1.meY<295){
    me1.meX=0;
    me1.meY=0;
  }
  //STAIRS RIGHT
  ...
  rect(270, 258, 4, 4);
  //Dialogue
  if(mouseX>236&&mouseX<244&&mouseY<278&&mouseY<262){
    fill(255,255,255,200);
    text("An empty water bottle/",185,250);}
  //Trash
  fill(194, 194, 214, random(100, 230));
  ...
  for (let x = 0; x < width; x = x + 18) {
   ...
   //Boundaries
  if(me1.meX<100&&me1.meY>370){
    me1.meX=0;
    me1.meY=0;
  }
  if(me1.meX>300&&me1.meY>370){
    me1.meX=0;
    me1.meY=0;
  }
  //Mice
  ...
  rect(206, 354, 2, 9);
  //Dialogue
  if(mouseX>194&&mouseX<207&&mouseY>354&&mouseY<365){
    fill(255,255,255,200);
    text("A mice.", 182,350);}
...
function Scene3() {
  ...
  rect(80,200,180,60);
   //Boundaries
  if(me1.meY<160&&me1.meX>0){
    me1.meX=0;
    me1.meY=200;
  }
  if(me1.meY>240&&me1.meX>0){
    me1.meX=0;
    me1.meY=200;
  }
  //CHAIR
  ...
  if(mouseX>40&&mouseX<60&&mouseY>170&&mouseY<190){
    fill(255,255,255,200);
    text("Sorry,I dont have cash.",5,168);}
  //People2
  fill(51, 26, 0,230);
  ...
  ellipse(103,222,3,3);
   //Dialogue2
  if(mouseX>90&&mouseX<110&&mouseY>210&&mouseY<230){
    fill(255,255,255,200);
    text("...",95,205);}
  ...
  ellipse(303,178,3,3);
  //Dialogue3
  if(mouseX>220&&mouseX>240&&mouseY>170&&mouseY<190){
    fill(255,255,255,200);
    text("Oh...",288,168);}
  ...
  ellipse(463,222,3,3);
   //Dialogue4&5
  if(mouseX>450&&mouseX<470&&mouseY>210&&mouseY<230){
    fill(255,255,255,200);
    text("Whisper...",440,207);}
  if(mouseX>490&&mouseX<510&&mouseY>210&&mouseY<230){
    fill(255,255,255,200);
    text("Whisper*2...",480,207);}
  ...
  fill(0,0,0,150);
  text("Replay",522,353);
    if (mouseX>510&&mouseX<570&&mouseY>320&&mouseY<380&&mouseIsPressed == true) {
      scene++;
      me1.meX=200;
      me1.meY=400;
    }
